...
My research expertise lies in experimental fluid mechanics, with a particular focus on two-phase flows. During my doctoral studies at Tel Aviv University and now at my postdoctoral work in [Erinin Research Group](https://erinin.engin.umich.edu/) at the **University of Michigan**, I am studying various air-sea interaction processes, such as wind wave generation and evolution, wave breaking, and droplet dynamics, under controlled laboratory settings. 

---
### Residence time of droplets generated by breaking waves

I am currently investigating the statistical properties of droplets produced by mechanically generated breaking waves, using high-speed in-line holography \cite{ernin_23b}. Initial results show that droplet dynamics are strongly influenced by wave-induced airflow. I am also developing a simplified numerical model to simulate droplet trajectories. This result highlights the critical role of wave-induced airflow in governing droplet dynamics, an aspect largely overlooked in previous studies or modeling efforts; we are currently preparing a manuscript to present these findings. 
